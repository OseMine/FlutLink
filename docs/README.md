...
> **Android client:** `android/` is a port of the desktop app to Kotlin +
> Jetpack Compose, generated by opencode (see
> [`android/README.md`](../android/README.md)). It mirrors the desktop feature
