...
> **Mobile client:** `kmp/` is a Kotlin Multiplatform port of the desktop app
> (Android + iOS in one codebase), generated by opencode (see
> [`kmp/README.md`](../kmp/README.md)). It mirrors the desktop feature
> set and is not a separate product.
