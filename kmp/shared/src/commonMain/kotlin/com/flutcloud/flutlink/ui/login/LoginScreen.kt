    ...
    Scaffold { innerPadding ->
        ScrollableColumn(
            ...
            OutlinedTextField(
                ...
                label = { Text(if (registerMode) stringResource(Res.string.login_new_username) else stringResource(Res.string.username)) },
                singleLine = true,
                modifier = Modifier.fillMaxWidth()
            )
            Spacer(Modifier.height(12.dp))
            OutlinedTextField(
                ...
                label = { Text(if (registerMode) stringResource(Res.string.login_password) else stringResource(Res.string.app_token)) },
                singleLine = true,
            ...
            if (registerMode) {
                ...
                Text(
                    stringResource(Res.string.admin_credentials),
                ...
                Text(
                    stringResource(Res.string.register_description),
