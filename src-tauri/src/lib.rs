...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::file_versions_list,
            commands::file_versions_restore,
            commands::file_versions_download,
            commands::rotate_account_token,
            ...
            commands::admin_bulk_add_group_members,
            commands::admin_bulk_remove_group_members,
            commands::admin_activity_log,
            commands::sync_list,
            commands::sync_add,
