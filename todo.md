...
- [x] **K4 (Doku, minor):** `kmp/README.md:41-44` behauptet „iOS-Targets sind
      ...
      → erledigt: `kmp/README.md` beschreibt die iOS-Targets jetzt korrekt
      (deklariert, macOS-only kompilierbar, ohne `iosMain`-Code; produktiver
      iOS-Port bleibt `ios/`).
