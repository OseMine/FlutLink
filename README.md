...
- **Phase 3 (in progress):** Chunked uploads/downloads with progress events (`app.emit`), drag & drop upload, select-all and bulk download/delete in the file browser. Remaining: `resources`/`parts` dual-pane workflows, symlink/virtual-link resolution.
