---
description: FlutLink-Review ausführen und reports/review-<datum>.md schreiben
agent: reviewer
---
...
3. Lege reports/review-YYYY-MM-DD.md so früh wie möglich an und ergänze es
   während des Reviews schrittweise.
4. Hänge neue Befunde als datierten Abschnitt oben in todo.md an (falls
   vorhanden), ohne bestehende Einträge zu verändern.
5. Ändere KEINEN Anwendungscode, nur Berichte und todo.md. Keine Findings ohne
